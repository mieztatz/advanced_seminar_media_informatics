...
%In section \ref{sec:terms_of_definition} the term intimate is defined by gathering different definitions to 
%In section \ref{sec:intimateData} the mentioned above questions are investigated. Each question or rather topic is treated in a separate subsection. The following section \ref{sec:methodology} describe the models and assumptions. In particular, how to answer the partly very subjective questions in general.
