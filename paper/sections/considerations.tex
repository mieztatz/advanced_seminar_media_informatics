...
They have grouped the different types of attacks by abusers in four categories, A summary of these categories and examples is shown in figure \ref{}.

\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{img/abusing_categories.png}
	\caption{Summary of different types of attacks by abusers in intimate partner violence context.}
...
%
%Die zusammengefassten Kategorien sind im folgenden genauer beschrieben.
%
%\textit{Ownership of devices and accounts} 
%Täter und Opfer haben oder hatten eine intime Beziehung in der realen Welt. Das bedeutet, sie wohnen oder wohnten zusammen, teilen gemeinsamen Besitz und sehr oft auch wird die finanzielle Situation von einem getragen. In vielen Fällen ist der Täter der rechtmäßige Besitzer eines Devices oder Accounts.
%Folgende Dinge wurden in der Studie beobachtet:
%\begin{itemize}
%	\item Test
%\end{itemize}
