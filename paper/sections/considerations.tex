...
In addition, this kind of feedback does not necessarily have to be of good quality and a lasting effect on interpersonal relationships. \cite{doi:10.1080/15265161.2017.1409823}. A good relationship is not measured by how much sex one has or how long it lasts. As explained in the section \ref{sec:terms_of_definition} above, each relationship is individual and to complex to be rated by numbers. There are other intrinsic values that make a good relationship.
