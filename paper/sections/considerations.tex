...
\begin{figure}[htb]
	...
	\caption{The Glow app collects a variety of intimate data (from \cite{glowApp})}
	\label{fig:glow_app}
\end{figure}
...
\begin{figure}[htb]
	...
	\caption{Surveillance may take place both through applications, social media, etc. and in interpersonal relationships (based on \cite{ethicsOfSurveillance})}
