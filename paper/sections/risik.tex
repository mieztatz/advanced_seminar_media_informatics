...
It used to be tracked without digital helpers, see  \ref{sec:c} the symptothermal method model from Roetzer. %TODO: Quelle: Natural Conception Regulation – the Way of Partnership. The Sympto-Thermal Method. %TO DO: Anders nennen: Natural conception regulation NCR

%TODO: Es fehlt ein UNDO für Datenteilung


%TODO: Sicherheitsmodel passt nicht für diesen speziellen Fall
